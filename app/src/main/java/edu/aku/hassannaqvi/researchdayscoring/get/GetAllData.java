package edu.aku.hassannaqvi.researchdayscoring.get;
...
//        pd.show();
    ...
    protected String doInBackground(String... args) {
        ...
        try {
            switch (syncClass) {
                case "users":
                    url = new URL(MainApp._HOST_URL_1 + UsersContract.UsersTable._URI);
                    position = 0;
                    break;
                case "projects":
                    url = new URL(MainApp._HOST_URL_1 + ProjectsContract.ProjectsTable._URI);
                    position = 1;
                    break;
